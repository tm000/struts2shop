...
<html>
<head>
<title>Orders placed by you</title>
</head>
<body>
	<%-- TODO: Add pager. --%>
		...
		<table class="ListTable">
			...
			<s:iterator value="orders" status="num">
				<tr class="<s:property value="#num.odd == true ? 'Odd' : 'Even'"/>">
					...
					<td class="Number"><s:url action="order" namespace="/buyer"
							var="viewOrderUrl">
							<s:param name="id" value="%{id}" />
						</s:url> <s:a href="%{#viewOrderUrl}">
					...
					<td class="Number"><s:url action="order!items"
							namespace="/buyer" var="orderItemspUrl">
							<s:param name="id" value="id" />
						</s:url> <s:a href="%{#orderItemspUrl}">
					...
					<td class="Actions">
						<ul>
							<li><s:a href="%{#viewOrderUrl}">View</s:a></li>
