		...
		<table class="ListTable">
			...
			<s:iterator value="subcarts" status="num">
				<tr class="<s:property value="#num.odd == true ? 'Odd' : 'Even'"/>">
					...
					<td class="Number"><s:url namespace="/" action="cart!items"
							var="cartItemsUrl">
							<s:param name="shopId" value="%{shop.id}" />
						</s:url> <s:a href="%{#cartItemsUrl}">
							<s:property value="itemCount" />
						</s:a></td>
					<td class="Number"><s:property value="totalQuantity" /></td>
					<td class="Number"><s:property value="totalPrice" />&nbsp;<s:property
							value="currency" /></td>
					<td class="Actions"><s:url namespace="/checkout"
							action="begin" var="beginCheckoutUrl">
							<s:param name="shopId" value="%{shop.id}" />
						</s:url>
						<ul>
							<li><s:a href="%{#beginCheckoutUrl}">
									<s:text name="msgkey.action.beginCheckout" />
								</s:a></li>
							<li><s:a href="%{#cartItemsUrl}">
									<s:text name="msgkey.action.editCart" />
								</s:a></li>
							<li><s:a href="#TODO">TODO: <s:text
										name="msgkey.action.delete" />
								</s:a></li>
						</ul></td>
				</tr>
			</s:iterator>
