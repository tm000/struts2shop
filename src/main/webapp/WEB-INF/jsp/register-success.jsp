...
<body>
	...
	<a href="<%= request.getContextPath() %>/member/home"><s:property
			value="currentUser.fullName" /></a>.
	<p />
	TODO: Offer to submit additional user's info like: First name, Last
	name, Date of Birth, Addresses, Contacts...
	<p />
	<%-- 
		...
		--%>
	You can start from
	<a href="<%= request.getContextPath() %>/member/home">here</a>.
</body>
</html>