...
<%-- TODO: i18n --%>
<h2>
	<s:text name="msgkey.title.createNewAddress" />
</h2>
...
<%-- TODO: i18n --%>
<h2>
	<s:text name="msgkey.title.selectPrevAddress" />
</h2>
<s:iterator value="addresses" var="address" status="num">
	...
	<table class="InlineHiddenTable">
		<tr>
			<td><s:form namespace="/checkout" action="%{returnTo}!submit"
					theme="simple">
					<s:hidden name="checkoutId" value="%{checkoutId}" />
					<s:hidden name="returnTo" value="%{returnTo}" />
			...
			<td><s:form namespace="/checkout" action="address"
					theme="simple">
					<s:hidden name="checkoutId" value="%{checkoutId}" />
					<s:hidden name="returnTo" value="%{returnTo}" />
					<s:hidden name="addressId" value="%{#address.id}" />
