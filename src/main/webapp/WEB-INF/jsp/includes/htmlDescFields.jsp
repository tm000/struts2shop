...
<h:formField fieldName="${entityName}.summary" inputId="summaryTextArea"
	...
	<s:textarea theme="simple" id="summaryTextArea"
		cssClass="SummaryTextArea" name="%{entityName}.summary" rows="8"
		cols="60" disabled="%{generateSummary}" />
	<br />
	...
	<label for="generateSummary"><s:text
			name="msgkey.text.autogenSummaryFromDesc" /></label>
</h:formField>

<s:textarea id="descTextArea" cssClass="HtmlEditorArea"
	name="description" key="msgkey.label.description" rows="20" cols="60" />
