...
<body>
	...
	<s:push value="order">
		...
		<p />
		<h2>
			<s:text name="msgkey.title.products" />
		</h2>
		<table class="ListTable">
			...
			<s:iterator value="orderItems" status="num">
				...
				<tr class="<s:property value="#num.odd == true ? 'Odd' : 'Even'"/>">
					<td>
						<%-- TODO: Duplication: See [buyer/order.jsp] --%> <a
	...
	<s:form namespace="/checkout" action="place-order">
		...
		<s:textarea cssClass="SmallHtmlEditorArea" name="buyerNotes"
			key="msgkey.label.checkout.buyerNotes" rows="10" cols="60" />
