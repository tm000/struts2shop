		...
		<table class="ListTable">
			...
			<s:iterator value="paymentMethods" status="num">
				<tr class="<s:property value="#num.odd == true ? 'Odd' : 'Even'"/>">
					...
					<td><s:url action="payment-method" namespace="/member"
							var="paymentMethodUrl">
							<s:param name="id" value="%{id}" />
						</s:url> <s:a href="%{#paymentMethodUrl}">
					...
					<td class="Actions"><s:url action="payment-method"
							namespace="/member" var="viewPaymentMethodUrl">
							<s:param name="id" value="%{id}" />
						</s:url> <s:url action="payment-method!edit" namespace="/member"
							var="editPaymentMethodUrl">
							<s:param name="id" value="%{id}" />
						</s:url> <s:url action="payment-method!deleteConfirm" namespace="/member"
							var="deletePaymentMethodUrl">
							<s:param name="id" value="%{id}" />
						</s:url>
						<ul>
							<li><s:a href="%{#viewPaymentMethodUrl}">
									<s:text name="msgkey.action.view" />
								</s:a></li>
							<li><s:a href="%{#editPaymentMethodUrl}">
									<s:text name="msgkey.action.edit" />
								</s:a></li>
							<li><s:a href="%{#deletePaymentMethodUrl}">
