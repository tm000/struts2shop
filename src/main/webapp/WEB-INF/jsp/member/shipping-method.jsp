		...
		<s:push value="shippingMethod">
			<table class="ViewTable">
				...
				<tr>
					...
					<td><s:property value="price" />&nbsp;<s:property
							value="currency" /></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><s:url action="shipping-method!edit" namespace="/member"
							...
							<s:param name="id" value="%{id}" />
						</s:url> <s:a href="%{#editShippingMethodUrl}">
							<s:text name="msgkey.action.edit" />
						</s:a>, <s:a href="%{#deleteShippingMethodUrl}">
