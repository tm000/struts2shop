		...
		<s:push value="category">
			<table class="ViewTable">
				...
				<tr>
					...
					<td><s:url action="category!edit" namespace="/member"
							var="editCategoryUrl">
							<s:param name="id" value="%{id}" />
						</s:url> <s:url action="category!deleteConfirm" namespace="/member"
							var="deleteCategoryUrl">
							<s:param name="id" value="%{id}" />
						</s:url> <%-- TODO: Refactor: Replace by link to "Products by user ID and category name". --%>
						<s:url action="category!products" namespace="/"
							var="categoryProductsUrl">
							<s:param name="categoryName" value="%{name}" />
						</s:url> <s:a href="%{#editCategoryUrl}">
							<s:text name="msgkey.action.edit" />
						</s:a>, <s:a href="%{#deleteCategoryUrl}">
							<s:text name="msgkey.action.delete" />
						</s:a>, <s:a href="%{#categoryProductsUrl}">
