...
<div id="cartPreviewBlock" class="CartPerPage">
	...
	<s:else>
		...
		<s:a cssClass="CheckoutButton" href="%{#proceedToCheckoutUrl}">
			<s:text name="msgkey.action.proceedToCheckout" />
		</s:a>
		...
		<div class="CartItemsWrapper">
			<table class="CartItems">
				<s:iterator value="%{cartItems}">
					...
					<tr>
						<td class="ImageCell"><a class="ThumbnailLink"
						...
						<td class="InfoCell">
							<div>
								...
								<div>
									...
									&nbsp;&times;&nbsp;<span class="ProductPrice"><s:property
											value="price" />&nbsp;<s:property value="currency" /></span>
								</div>
							</div>
							<div class="RemoveLink">
								<s:form namespace="/ajax" action="cart!deleteCartItem"
									...
									<s:submit type="submit"
										key="msgkey.action.small.removeFromCart" />
								</s:form>
							</div>
						</td>
					</tr>
